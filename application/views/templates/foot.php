...
<script type="text/javascript">
    $('#video-play').click(function() {
        $(this).replaceWith('<iframe src="http://player.vimeo.com/video/53805056?autoplay=true" width="600" height="336" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>')
    })
</script>
  <script type="text/javascript">
(function() {
